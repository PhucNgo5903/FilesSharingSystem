...
SERVER_SRC = src/server/main.c src/server/transfer.c src/server/auth_mgr.c src/server/group_mgr.c src/server/fs_mgr.c $(COMMON_SRC)
CLIENT_SRC = src/client/main.c src/client/file_handler.c src/client/auth_handler.c src/client/cmd_handler.c $(COMMON_SRC)
